        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
             ...
             /*   requestParameter.put("email", "yang115@qq.com");
                ...
                requestParameter.put("userId", "");
                requestParameter.put("name", "123456");
                requestParameter.put("portraitUri", "123456");
                    ...
                    if (result != null) {
                        ...
                        if (object.getInt("code") == 200) {
                           token = jobj.getString("token");
                            //yang115@qq.com 该用户获取的
                           // token = "pfvPREIUen1KcSbDuQVxNDu/ZN+QKL0DmF6j/Q6XgpSCZ3ubVbAQ+Cc1maY3ISshw8XHHeNlJGBl/pkwX2MUpVPJ77IjXKy6u6sQWr8xpkk=";
                            connect(token);
...
/**
                ...
                public void onSuccess(String userid) {
                    ...
                    startActivity(new Intent(RongyunLoginActivity.this, RongyunMainActivity.class));
                    finish();
                }
