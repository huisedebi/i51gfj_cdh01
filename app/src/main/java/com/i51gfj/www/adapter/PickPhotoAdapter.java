...
import com.i51gfj.www.model.Photo;
...
/**
 */
public class PickPhotoAdapter extends RecyclerView.Adapter<PickPhotoHolder>{

    public List<String> data;
    FragmentActivity mActivity;
    MineSendRedFragment fragment;

    public PickPhotoAdapter(FragmentActivity mActivity, MineSendRedFragment mineSendRedFragment) {
