...
import com.i51gfj.www.adapter.RedAdvaAdapter;
 ...
 */
public class RedAdvaFragment extends BaseFragment {
    private RedListBean data;
    private RecyclerView recyclerView;
    private TextView tiele_tv;
    private TextView left_tv;
    private TextView right_tv;
    private RedAdvaAdapter adapter;
    ...
    public void initView(View view) {
        ...
        adapter = new RedAdvaAdapter(mActivity,this);
 ...
 /*   lng        *经纬度    极光请求里的经纬度
    ...
    public void post_main() {
        ...
        try {
            ...
            json.put("typeId",typeId==null?"":typeId);
    ...
    public void onMyItemClick(Object data) {
        ...
        fragmentTransaction.hide(RedAdvaFragment.this);
