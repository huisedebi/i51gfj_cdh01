/*
package com.i51gfj.www.view.sortlistview;
...
//		final SortModel mContent = list.get(position);
     ...
     */
/*  } else if (position <= last_call_city.size()) {
            String last_city = last_call_city.get(position - 1);
            viewHolder.tvLetter.setVisibility(position - 1 == 0 ? View.VISIBLE : View.GONE);
            viewHolder.tvLetter.setText("最近访问的城市");
            if(last_city!=null && !last_city.equals("")){
                viewHolder.tvTitle.setText(last_city);
            }else{
                viewHolder.tvTitle.setText(ShpfUtil.getStringValue("city_name"));
            }*//*
...
/*- last_call_city.size()*//*
 - 1);
            ...
            if (position */
/*- last_call_city.size()*//*
 - 1 == getPositionForSection(section)) {
                viewHolder.tvLetter.setVisibility(View.VISIBLE);
                viewHolder.tvLetter.setText(list.get(position */
/*- last_call_city.size()*//*
 - 1).getSortLetters());
            } else {
